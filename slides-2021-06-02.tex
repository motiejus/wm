...
\begin{frame}
  \begin{abstract}
    ...
    Dabartiniai linijų simplifikavimo algoritmai prastai tinka upėms. Šis
    darbas realizuoja {\WM} algoritmą. Jis geriau tinka upėms.
...
\begin{frame}{Realizacijos išvados}
  \begin{itemize}[<+->]
    ...
    \item Prienami simplifikavimo algoritmai ne itin tinka upėms.
